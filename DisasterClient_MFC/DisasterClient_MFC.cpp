...
// DisasterClient_MFC.cpp: 定义应用程序的类行为。
//
...
BEGIN_MESSAGE_MAP(CDisasterClientMFCApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// CDisasterClientMFCApp 构造

CDisasterClientMFCApp::CDisasterClientMFCApp()
{
	// 支持重新启动管理器
...
// 唯一的 CDisasterClientMFCApp 对象

CDisasterClientMFCApp theApp;


// CDisasterClientMFCApp 初始化
